...
SNAPSHOTS_TABLE_NAME = 'binance_spot_depth200_snapshots'
...
@asset(
    ...
    description='Creates the binance_spot_depth200_snapshots table if it does not exist',
)
def create_binance_spot_depth200_snapshots_table_origo(
