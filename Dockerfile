...
RUN --mount=type=ssh,id=trades-warehouse \
    ...
    pip install --no-cache-dir --upgrade git+ssh://git@github.com/vaquum/vaquum-tools.git && pip install --no-cache-dir --upgrade git+ssh://git@github.com/vaquum/Loop.git
